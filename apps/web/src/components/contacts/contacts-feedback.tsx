...
export function ContactsEmptyState({ onResetFilters }: { onResetFilters: () => void }) {
  return (
    <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-zinc-800 bg-zinc-950/40 p-12 text-center my-6">
      ...
      <p className="text-xs text-zinc-400 mt-1 max-w-sm">
        No contact records match your active query filters.
      </p>
...
export function ContactsErrorState({ onRetry }: { onRetry: () => void }) {
  return (
    <div className="flex flex-col items-center justify-center rounded-2xl border border-red-500/20 bg-red-500/5 p-12 text-center my-6">
      ...
      <h3 className="text-sm font-bold text-white">Contacts Query Failure</h3>
      <p className="text-xs text-zinc-400 mt-1 max-w-sm">
        Failed to fetch contacts catalog records from service endpoint.
      </p>
