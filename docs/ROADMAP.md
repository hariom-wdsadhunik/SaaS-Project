...
- **v3.7.0 (Enterprise AI Intelligence Platform):** Centralized AI Intelligence Engine, Predictive Lead & Opportunity Scoring, Deal Win Probability, Churn Risk, Revenue Forecasting with 85-95% Confidence Intervals, Next Best Action Engine, Explainable AI (XAI) Insights, and `/ai` UI sub-app (`/ai`, `/ai/insights`, `/ai/forecast`, `/ai/leads`, `/ai/recommendations`).
