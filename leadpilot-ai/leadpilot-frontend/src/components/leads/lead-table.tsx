        ...
        return (
          <div className="relative flex items-center justify-end gap-1">
            ...
            <button
              ...
              className="rounded p-1 text-zinc-400 hover:bg-zinc-800 hover:text-emerald-400 transition-colors"
              title="Call Lead"
            >
            ...
            {activeMenuId === lead.id && (
              <div className="absolute right-0 top-7 w-36 rounded-xl border border-zinc-800 bg-zinc-900 p-1 shadow-xl z-20 animate-in fade-in duration-100">
                ...
                <button
                  ...
                  className="flex w-full items-center px-2.5 py-1.5 text-xs text-indigo-400 hover:bg-indigo-500/10 rounded-lg"
                >
                  Convert to Deal
                </button>
              </div>
